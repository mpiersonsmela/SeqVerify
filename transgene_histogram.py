...
def histogram(bins,counts,chromosome,granularity=1,rounding=1, significant=1):
    try:
        ...
        std_dev = (sum([(i-mean)**2 for i in counts])/len(counts))**0.5
...
#chrHistograms('samtools_depth_-b_cov.txt', ["T2A-tdTomato","CK580_FIGLA"])